...
BLOG_AUTHOR = "Ganesh Krishnan"  # (translatable)
BLOG_TITLE = "Swimming on Land"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ganesh-krishnan.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ganesh-krishnan.github.io/"
BLOG_EMAIL = "innocent4eternity@gmail.com"
BLOG_DESCRIPTION = "Random musings on life, spirituality and machine learning"  # (translatable)
